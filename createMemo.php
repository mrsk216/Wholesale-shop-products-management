        ...
        if($oldFreeProduct >= $productFree){
            if($oldProductQuantity >= $productLoad){
                if($productLoad >= $productReturn){
                    ...
                    $sql = "INSERT INTO `memo`(`brand_name`, `area_name`, `delivery_man`, `product_name`, `product_load`, `product_free`, `product_return`, `product_sale`,`product_damage`,`product_rate`) VALUES ('$brandName','$areaName','$delManName','$productName','$productLoad','$productFree','$productReturn','$sale','$productDamage','$productRate')";
